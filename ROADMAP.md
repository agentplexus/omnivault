...
|------|--------|----------|------|
| Core `vault.Vault` interface | ✅ | - | - |
| Built-in providers (env, file, memory) | ✅ | - | - |
| URI-based resolver | ✅ | - | - |
| External provider module architecture | ✅ | - | - |
| omnivault-aws provider module | ✅ | - | - |
| omnivault-keyring provider module | ✅ | - | - |
| AES-256-GCM encryption with Argon2id key derivation | ✅ | - | - |
| Encrypted file store implementing `vault.Vault` | ✅ | - | - |
| Master password protection | ✅ | - | - |
| Configurable auto-lock timeout | ✅ | - | - |
| Platform-specific paths (~/.omnivault/) | ✅ | - | - |
| IPC protocol definitions | ✅ | - | - |
| HTTP server over Unix socket | ✅ | - | - |
| Lock/unlock session management | ✅ | - | - |
| CLI entrypoint | ✅ | - | - |
| Secret commands (get, set, list, delete) | ✅ | - | - |
| Vault commands (init, lock, unlock, status) | ✅ | - | - |
